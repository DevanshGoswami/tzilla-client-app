...
export default function RootLayout() {
    ...
    useEffect(() => {
        if (!tokenLoading && !splashAnimationStarted) {
    ...
    }, [tokenLoading, splashAnimationStarted, startHideSplash, appStart]);
...
function TextOverlay() {
    return (
        <View style={styles.textWrapper}>
            ...
            <RNText style={styles.splashSubtitleSmall}>Fitness engineered for humans</RNText>
        </View>
    );
}
